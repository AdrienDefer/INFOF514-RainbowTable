...
int main(int argc, const char * argv[]) {
    ...
    if (strtol(argv[1], NULL, 10) == 0) {
        start_rainbow_table_creation(strtol(argv[2], NULL, 10), strtol(argv[3], NULL, 10));
    } else if (strtol(argv[1], NULL, 10) == 1) {
        start_cracking((char*) argv[3], strtol(argv[2], NULL, 10));
    } else if (strtol(argv[1], NULL, 10) == 2) {
        fill_hash_to_crack_file();
    } else if (strtol(argv[1], NULL, 10) == 3) {
        mass_cracking(strtol(argv[2], NULL, 10));
    } else {
